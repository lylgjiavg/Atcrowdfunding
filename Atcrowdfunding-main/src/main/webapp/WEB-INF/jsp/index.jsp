      ...
      <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <ul class="nav navbar-nav navbar-right">
                <li><a href="${contextPath }/login.htm">登录</a></li>
                <li><a href="${contextPath }/reg.htm">注册</a></li>
              </ul>
            </div>
			  </div>
			</nav>
...
<div class="container">
	...
	<script src="${contextPath }/script/docs.min.js"></script>
    <script src="${contextPath }/script/back-to-top.js"></script>
    <script>
